    ...
    <div className="flex min-h-screen bg-brand-cream">
      <aside className="w-64 bg-brand-navy flex flex-col fixed h-full">
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-1">
          <Link href="/admin/settings" className="flex items-center gap-3 px-4 py-2.5 rounded-[16px] text-sm font-ui text-white/40 hover:text-white/70 transition-colors">
            <Settings size={18} />
            <span>Settings</span>
          </Link>
          <button className="flex items-center gap-3 px-4 py-2.5 rounded-[16px] text-sm font-ui text-white/40 hover:text-semantic-red transition-colors w-full">
            <LogOut size={18} />
            <span>Sign Out</span>
          </button>
        </div>
