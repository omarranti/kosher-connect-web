  ...
  return (
    <section id="waitlist" className="relative overflow-hidden bg-brand-navy px-6 py-24 sm:py-28">
      ...
      <div className="relative mx-auto max-w-xl">
        <div className="overflow-hidden rounded-brand border border-white/10 bg-white p-8 shadow-card-hover sm:p-10">
          {/* Top gradient accent */}
          ...
          {!submitted ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    <label className="mb-1.5 block font-ui text-xs font-semibold text-brand-navy">First Name</label>
                    <input
                      type="text"
                      name="firstName"
                      required
                  ...
                  <div>
                    <label className="mb-1.5 block font-ui text-xs font-semibold text-brand-navy">Last Name</label>
                    <input
                      type="text"
                      name="lastName"
                      required
                ...
                <div>
                  <label className="mb-1.5 block font-ui text-xs font-semibold text-brand-navy">Email Address</label>
                  <input
                    type="email"
                    name="email"
                    required
                ...
                <div>
                  <label className="mb-1.5 block font-ui text-xs font-semibold text-brand-navy">
                ...
                <p className="text-center font-ui text-[11px] text-brand-navy/40">
            ...
            <div className="py-10 text-center">
              ...
              <h3 className="font-display text-2xl font-bold text-brand-gold sm:text-3xl">You&apos;re In!</h3>
              ...
              <div className="mt-5 inline-flex items-center gap-2 rounded-pill bg-brand-gold-pale/40 px-5 py-2.5">
