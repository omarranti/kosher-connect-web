    ...
    <section id="pricing" className="py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-10 text-center">
          ...
          <div className="mt-5 flex justify-center gap-6 font-ui text-xs text-brand-navy/30">
            <a href="/terms" className="hover:text-brand-navy/50 transition-colors">Terms of Use</a>
            <a href="/privacy" className="hover:text-brand-navy/50 transition-colors">Privacy</a>
          </div>
        </div>
      </div>
    </section>
